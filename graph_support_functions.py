...
def create_all_data(start, end, data_file, n, config_file):
    ...
    # Creating an empty dataframe to store the latitude, longitude, and altitude combinations.
    df = pd.DataFrame()
    lats = []
    longs = []
    alts = []
    ...
    # Converting the None values to NaN.
