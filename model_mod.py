...
# Inputs:
# 'data_file' variable requires the directory of a singular data file (either Long Pulse or Alternating Code) or...
# if both files will be used, input directory to the Long Pulse data file.
data_file = ["20171119.001_lp_1min-fitcal-shrunk.h5"]
# 'AC_data_file' variable requires the directory to the Alternating Code otherwise delete all strands within brackets.
AC_data_file = []
# This variable only extracts data below this altitude for plotting. Altitude in meters.
AC_Alt_lim = 260_000
start = "2017-11-20T19:14:00"
end = "2017-11-20T19:17:00"
